...
Vector databases are where your embeddings live. This module covers how they work from first principles — ANN (Approximate Nearest Neighbor) algorithms, index types, tuning parameters — and then shows concrete production schemas for the most common options.

## Why This Module Matters

- **Index type determines your quality-speed trade-off.** HNSW (Hierarchical Navigable Small World), IVF (Inverted File index), and flat indexes have fundamentally different performance characteristics.
...
|------|-------|:---:|
| [Vector DB Internals](01-vector-db-internals.md) | ANN algorithms, HNSW, IVF, PQ (Product Quantization), scaling, DB comparison | 🔥🔥🔥 |
