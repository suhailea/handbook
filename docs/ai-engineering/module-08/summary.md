...
[Module 9 — Model Serving](/ai-engineering/module-09/) covers what to do once an architecture calls for running a model yourself: cloud vs local vs self-hosted, GGUF, vLLM, and quantization.
