...
[Module 10 — AI Infrastructure & Cloud](/ai-engineering/module-11/) covers the infrastructure that runs these systems at scale: Docker for AI workloads, Kubernetes for AI services, Azure OpenAI and AKS, and GPU-based model serving.
