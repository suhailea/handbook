...
- [6.5 Linear Algebra for AI](./05-linear-algebra-for-ai) — vectors and matrices that implement the math above
- [6.6 ML Metrics](./06-ml-metrics) — statistical metrics for model evaluation
